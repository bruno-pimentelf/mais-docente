...
import { ITitleThreeCardThreeTopImages4SlideFactory } from './slide-factory.interface';

export class TitleThreeCardThreeTopImages4SlideFactory implements ITitleThreeCardThreeTopImages4SlideFactory {
  ...
  create(
    ...
    const imageHeight = 244; // Image height within each card
    ...
    return {
      ...
      slideType: SlideThemeType.TITLE_THREE_CARD_THREE_TOP_IMAGES_4,
      themeSettings: {
