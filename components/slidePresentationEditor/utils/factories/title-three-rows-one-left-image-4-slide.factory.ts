...
export class TitleThreeRowsOneLeftImage4SlideFactory
  implements ITitleThreeRowsOneLeftImageSlideFactory
{
  ...
  private calculateAspectRatioDimensions(
    ...
    const aspectRatio = SLIDE_IMAGE_RATIOS._0_74;
  ...
  async create(
    ...
    return {
      ...
      slideType: SlideThemeType.TITLE_THREE_ROWS_ONE_LEFT_IMAGE_4,
      themeSettings: {
