...
export class TitleTwoCardTwoTopImages3SlideFactory implements ITitleTwoCardTwoTopImages1SlideFactory {
  ...
  create(
    ...
    const titleGap = 40; // Gap between title and cards
    ...
    // Cards area on the right side of title
    ...
    const imageHeight = 505; // Height for the image area
    ...
    return {
      ...
      slideType: SlideThemeType.TITLE_TWO_CARD_TWO_TOP_IMAGES_3,
      themeSettings: {
