...
export class NoTitleOnePlainTwoTopImages3SlideFactory implements INoTitleOnePlainTwoTopImagesSlideFactory {
  ...
  create(
    ...
    // Left side: Large image with aspect ratio 0.74
    const leftImageX = 135;
    const leftImageWidth = 567;
    const leftImageHeight = leftImageWidth / SLIDE_IMAGE_RATIOS._0_74;
    ...
    const gapBetweenLeftAndRight = 59;
    const rightAreaX = leftImageX + leftImageWidth + gapBetweenLeftAndRight;
    const rightAreaWidth = slideWidth - rightAreaX - 135;
    const rightAreaY = leftImageY; // Align with left image top
    const spacing = 20;

    // Small image on the right with aspect ratio 1.79
    const smallImageHeight = 466;
    ...
    return {
      ...
      slideType: SlideThemeType.NO_TITLE_ONE_PLAIN_TWO_TOP_IMAGES_3,
      themeSettings: {
