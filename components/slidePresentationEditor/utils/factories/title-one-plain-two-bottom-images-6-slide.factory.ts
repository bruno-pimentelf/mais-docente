...
export class TitleOnePlainTwoBottomImages6SlideFactory implements ITitleOnePlainTwoBottomImagesSlideFactory {
  ...
  create(
    ...
    // Images start after title with spacing
    const imageStartY = titleElement.y + titleHeight + 40;
    const imageHeight = 587;
    ...
    const secondImageWidth = imageHeight * SLIDE_IMAGE_RATIOS._1_44;
    ...
    return {
      ...
      slideType: SlideThemeType.TITLE_ONE_PLAIN_TWO_BOTTOM_IMAGES_6,
      themeSettings: {
