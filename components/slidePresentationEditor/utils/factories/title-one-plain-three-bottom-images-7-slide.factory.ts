...
export class TitleOnePlainThreeBottomImages7SlideFactory implements ITitleOnePlainThreeBottomImagesSlideFactory {
  ...
  create(
    ...
    const image1Width = Math.floor(imageHeight * SLIDE_IMAGE_RATIOS._1_01);
    ...
    return {
      ...
      slideType: SlideThemeType.TITLE_ONE_PLAIN_THREE_BOTTOM_IMAGES_7,
      themeSettings: {
