...
export class TitleOnePlainTwoRightImages3SlideFactory
  implements ITitleOnePlainTwoRightImagesSlideFactory
{
  ...
  create(
    ...
    // Right side (images)
    const imageWidth = 547; // Fixed width for images
    ...
    const topImageHeight = imageWidth / SLIDE_IMAGE_RATIOS._0_74; // Top image aspect ratio 0.74
    ...
    return {
      ...
      slideType: SlideThemeType.TITLE_ONE_PLAIN_TWO_RIGHT_IMAGES_3,
      themeSettings: {
