...
export class TitleOnePlainTwoBottomImages7SlideFactory implements ITitleOnePlainTwoBottomImagesSlideFactory {
  ...
  create(
    ...
    const imageHeight = 501;

    // Image layout: widths calculated based on aspect ratio and height
    const gap = 35;
    const firstImageAspectRatio = SLIDE_IMAGE_RATIOS._1_79;
    ...
    return {
      ...
      slideType: SlideThemeType.TITLE_ONE_PLAIN_TWO_BOTTOM_IMAGES_7,
      themeSettings: {
