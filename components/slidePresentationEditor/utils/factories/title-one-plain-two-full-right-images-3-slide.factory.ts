...
/**
 * Factory for creating title one plain two full right images 3 slides
 ...
 * - Both images have fixed width of 522px
 * - Top image has aspect ratio 0.74, bottom image has aspect ratio 1.44
 * - Text width is adjusted to leave a gap between text and images
 * Follows Single Responsibility Principle - only creates title one plain two full right images 3 slides
 */
export class TitleOnePlainTwoFullRightImages3SlideFactory
  implements ITitleOnePlainTwoFullRightImagesSlideFactory
{
  ...
  create(
    ...
    const imageWidth = 522; // Fixed width for both images
    ...
    return {
      ...
      slideType: SlideThemeType.TITLE_ONE_PLAIN_TWO_FULL_RIGHT_IMAGES_3,
      themeSettings: {
