...
import { ITitleAndTextCard3SlideFactory } from './slide-factory.interface';

export class TitleAndTextCard3SlideFactory
  implements ITitleAndTextCard3SlideFactory
{
  ...
  create(
    ...
    const card3Elements = createTextCard(card_3_title, card_3_text, 2);
    ...
    return {
      ...
      slideType: SlideThemeType.CARDS_1,
      themeSettings: {
