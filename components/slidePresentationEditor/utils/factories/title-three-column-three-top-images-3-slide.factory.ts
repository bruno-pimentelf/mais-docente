...
export class TitleThreeColumnThreeTopImages3SlideFactory
  implements ITitleThreeColumnThreeTopImagesSlideFactory
{
  ...
  create(
    ...
    // Middle card has fixed width of 750px
    const middleCardWidth = 750;
    // Left and right cards share remaining space equally
    ...
    return {
      ...
      slideType: SlideThemeType.TITLE_THREE_COLUMN_THREE_TOP_IMAGES_3,
      themeSettings: {
