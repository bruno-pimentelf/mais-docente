...
export class TitleTwoCardTwoTopImages7SlideFactory implements ITitleTwoCardTwoTopImages1SlideFactory {
  ...
  create(
    ...
    // Card 1: Left image with aspect ratio 0.74, centered
    const card1ImageWidth = imageHeight * SLIDE_IMAGE_RATIOS._0_74;
    ...
    return {
      ...
      slideType: SlideThemeType.TITLE_TWO_CARD_TWO_TOP_IMAGES_7,
      themeSettings: {
