...
import { ITitleThreeColumnTwoBottomImages1SlideFactory } from './slide-factory.interface';

export class TitleThreeColumnTwoBottomImages1SlideFactory
  implements ITitleThreeColumnTwoBottomImages1SlideFactory
{
  ...
  create(
    ...
    const createColumn = (
      ...
      const columnTitleHeight = getTextHeight({
        text: `<span style="overflow-wrap: break-word; color: ${this.colors.subtitleColor}; font-weight: bold;">${processMarkdownFormatting(columnTitle)}</span>`,
        fontSize: 48,
        fontFamily: 'Quicksand',
        lineHeight: 1.2,
        width: columnWidth,
    ...
    // Two images at the bottom of the slide (no margins)
    ...
    return {
      ...
      slideType: SlideThemeType.TITLE_THREE_COLUMN_TWO_BOTTOM_IMAGES_1,
      themeSettings: {
