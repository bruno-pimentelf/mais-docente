...
/**
 * Factory for creating title one plain two full right images 5 slides
 ...
 * - Both images have fixed width of 691px
 * - Top image has aspect ratio 1.01, bottom image has aspect ratio 1.79
 * - Text width is adjusted to leave a gap between text and images
 * Follows Single Responsibility Principle - only creates title one plain two full right images 5 slides
 */
export class TitleOnePlainTwoFullRightImages5SlideFactory
  implements ITitleOnePlainTwoFullRightImagesSlideFactory
{
  ...
  create(
    ...
    const imageWidth = 691; // Fixed width for both images
    ...
    return {
      ...
      slideType: SlideThemeType.TITLE_ONE_PLAIN_TWO_FULL_RIGHT_IMAGES_5,
      themeSettings: {
