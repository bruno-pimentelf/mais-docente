...
import { IMainImageSlideFactory } from './slide-factory.interface';

/**
 * Factory for creating main image slides
 * Follows Single Responsibility Principle - only creates main image slides
 */
export class MainImageSlideFactory implements IMainImageSlideFactory {
  ...
  async create(
    ...
    return {
      ...
      slideType: SlideThemeType.IMAGE_AND_TEXT_1,
      themeSettings: {
        baseWidth: 1920,
        baseHeight: 1080,
        width: 1920,
