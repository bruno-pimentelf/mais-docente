...
export class TitleTwoCardTwoTopImages5SlideFactory implements ITitleTwoCardTwoTopImages1SlideFactory {
  ...
  create(
    ...
    // Calculate image height based on aspect ratio 1.79
    const imageWidth = cardWidth - cardPadding * 2;
    const imageHeight = imageWidth / SLIDE_IMAGE_RATIOS._1_79;
    ...
    return {
      ...
      slideType: SlideThemeType.TITLE_TWO_CARD_TWO_TOP_IMAGES_5,
      themeSettings: {
