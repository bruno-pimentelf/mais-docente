...
import { ITitleThreeCardThreeTopImages3SlideFactory } from './slide-factory.interface';

export class TitleThreeCardThreeTopImages3SlideFactory implements ITitleThreeCardThreeTopImages3SlideFactory {
  ...
  create(
    ...
    const imageHeight = 550; // Image height
    ...
    return {
      ...
      slideType: SlideThemeType.TITLE_THREE_CARD_THREE_TOP_IMAGES_3,
      themeSettings: {
