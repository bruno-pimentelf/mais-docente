...
export class NoTitleOnePlainTwoTopImages1SlideFactory implements INoTitleOnePlainTwoTopImagesSlideFactory {
  ...
  create(
    ...
    const leftImageWidth = 773; // Same width as text area
    ...
    return {
      ...
      slideType: SlideThemeType.NO_TITLE_ONE_PLAIN_TWO_TOP_IMAGES_1,
      themeSettings: {
