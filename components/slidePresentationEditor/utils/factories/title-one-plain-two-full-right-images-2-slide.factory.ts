...
/**
 * Factory for creating title one plain two full right images 2 slides
 ...
 * - Both images have fixed width of 561px
 * - Top image has aspect ratio 0.74, bottom image has aspect ratio 1.79
 * - Text width is adjusted to leave a gap between text and images
 * Follows Single Responsibility Principle - only creates title one plain two full right images 2 slides
 */
export class TitleOnePlainTwoFullRightImages2SlideFactory
  implements ITitleOnePlainTwoFullRightImagesSlideFactory
{
  ...
  create(
    ...
    // Both images have fixed width of 561px
    const image1AspectRatio = SLIDE_IMAGE_RATIOS._0_74;
    const image2AspectRatio = SLIDE_IMAGE_RATIOS._1_79;
    const imageWidth = 561; // Fixed width for both images
    ...
    return {
      ...
      slideType: SlideThemeType.TITLE_ONE_PLAIN_TWO_FULL_RIGHT_IMAGES_2,
      themeSettings: {
